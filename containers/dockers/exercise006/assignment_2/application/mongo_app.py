...
class MongoDBRunner:
    ...
    def get_mongo_client(mongo_collection_string="mongodb:/localhost:27017/"):
        ...
        '''
        if os.getenv("MONGO_CONTAINER") is not None:
            mongo_collection_string = "mongodb://{}:27017/".format(os.getenv("MONGO_CONTAINER"))
            #mongo_collection_string = "mongodb://mongodb:27017/"
